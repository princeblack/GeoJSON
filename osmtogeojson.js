          ...
          (function (sn) {
            (function () {
              var _,
                ...
                p = /^(?:0|[1-9]\d*)$/,
                y = {};
              (y[I] = y[R] = y[D] = y[U] = y[$] = y[G] = y[C] = y[z] = y[
                W
              ] = !0),
                (y[m] = y[b] = y[L] = y[j] = y[F] = y[A] = y[k] = y[O] = y[
                  E
                ] = y[M] = y[T] = y[P] = y[S] = y[N] = y[a] = !1);
              var V = {};
              (V[m] = V[b] = V[L] = V[F] = V[j] = V[A] = V[I] = V[R] = V[D] = V[
                U
              ] = V[$] = V[E] = V[M] = V[T] = V[P] = V[S] = V[N] = V[B] = V[
                G
              ] = V[C] = V[z] = V[W] = !0),
                (V[k] = V[O] = V[a] = !1);
